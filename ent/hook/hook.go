...
// The GrainJarFunc type is an adapter to allow the use of ordinary
// function as GrainJar mutator.
type GrainJarFunc func(context.Context, *ent.GrainJarMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GrainJarFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GrainJarMutation); ok {
		return f(ctx, mv)
	}
